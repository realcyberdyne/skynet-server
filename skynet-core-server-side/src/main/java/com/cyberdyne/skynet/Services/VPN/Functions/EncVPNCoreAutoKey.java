...
//
//            String ReadHash = DIS.readUTF();
//            System.err.println("Readed : "+ReadHash);
//
//            Connectin_Models Connection = new ConnectionDTO().GetConnectionByHash(ReadHash);
//            System.err.println("Key is : "+Connection.getKey());
//        }
//        catch (Exception e)
//        {
//
//        }
        //Get Protocol hand shake in every request end
